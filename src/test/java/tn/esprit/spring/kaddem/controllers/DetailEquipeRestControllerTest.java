...
class DetailEquipeRestControllerTest {
    ...
    void testUpdateDetailEquipe() throws Exception {
        ...
        when(detailEquipeService.updateDetailEquipe(any(DetailEquipe.class))).thenReturn(detailEquipe);
        ...
        verify(detailEquipeService, times(1)).updateDetailEquipe(any(DetailEquipe.class));
    }
